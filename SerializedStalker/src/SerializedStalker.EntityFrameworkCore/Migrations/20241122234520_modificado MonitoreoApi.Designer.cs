...
namespace SerializedStalker.Migrations
{
    ...
    [Migration("20241122234520_modificado MonitoreoApi")]
    partial class modificadoMonitoreoApi
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SerializedStalker.Domain.Notificaciones.Notificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppNotificacion", (string)null);
                });

            modelBuilder.Entity("SerializedStalker.ListasDeSeguimiento.ListaDeSeguimiento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SerializedStalker.Series.MonitoreoApi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<float>("TiempoDuracion")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("SerializedStalker.Series.Serie", b =>
                {
                    ...
                    b.Property<string>("ImdbPuntuacion")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.HasIndex("ListaDeSeguimientoId");
            ...
            modelBuilder.Entity("SerializedStalker.Series.Serie", b =>
                {
                    b.HasOne("SerializedStalker.ListasDeSeguimiento.ListaDeSeguimiento", null)
                        .WithMany("Series")
                        .HasForeignKey("ListaDeSeguimientoId");
                });
