...
public class SerializedStalkerDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public SerializedStalkerDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
